...
app = Flask(__name__)
app.secret_key = 'Winterto2'
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////home/hdaylin/mysite/tmp/database.db'
db = SQLAlchemy(app)
...
def listing_delete(listing_id):
    ...
    db.session.commit()
    return render_template('listing_confirm_delete.html', listid=listing_id)
